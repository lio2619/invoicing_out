    ...
    public partial class 進貨單 : Form
    {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sql = "insert into 總單子_客戶 (日期, 時間, 客戶, 單子, 備註 ,總金額, 單子編號, 刪除) values (@day, @time, @store_name, '進貨單'," +
        ...
        private async void create_excel(string date, string file_name, string number)
        {
            ...
            file = new FileInfo(@"../單子/" + date + "/進貨單/" + file_name + ".xlsx");
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                模糊查詢 form2 = new 模糊查詢(e.RowIndex, "進貨單");
                form2.Owner = this;
                form2.Show();
            }
        }
        ...
        private async void button5_Click(object sender, EventArgs e)
        {
            ...
            string path = "../單子/" + date + "/進貨單/";
            if (!Directory.Exists(path))
            {
                Directory.CreateDirectory(path);
            }
            SQLConnect con = new SQLConnect();
            string SQL = "select 單子編號 from 總單子_客戶 where 日期=@time and 客戶=@store_name and 單子='進貨單' " +
            ...
            string file_name = "進貨單_" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "_" + comboBox1.Text.ToString();
